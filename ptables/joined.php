...
$this->fields = [
	[ "field" => "id",		"title" => "id",        "width" => "5%",	"print" 	=> "[id]%s" ],
	[ "field" => "notes",	"title" => "notes",		"width"	=> "5%",	"value"		=> "[id][status]" ],
	...
	[ "table" => "task",	"field" => "deadline",  "width" => "10%",	"title"     => "deadline",  "print"			=> "#%s#",	"extend" => "convert_date" ],
